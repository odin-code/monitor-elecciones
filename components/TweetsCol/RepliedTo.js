...
const RepliedTo = ({ repliedToData, users }) => {
  ...
  useEffect(() => {
    users &&
      ...
      getUser(repliedToData.author_id);
  }, [users, repliedToData]);
            ...
            <div className="mt-2 leading-normal whitespace-pre-wrap text-sm text-gray-700 dark:text-gray-200">
              ...
              <div className="flex text-gray-700 mt-2">
                <a
                  ...
                  href={`https://twitter.com/intent/tweet?in_reply_to=${repliedToData.id}`}
                  target="_blank"
                  rel="noopener noreferrer">
                  <svg
                    className="mr-2"
                  ...
                  <span>{repliedToData.public_metrics.reply_count}</span>
                </a>
                <a
                  title="Retweetear"
                  ...
                  href={`https://twitter.com/intent/retweet?tweet_id=${repliedToData.id}`}
                  target="_blank"
                  rel="noopener noreferrer">
                  <svg
                    className="mr-2"
                  ...
                  <span>
                    {repliedToData.public_metrics.retweet_count +
                      repliedToData.public_metrics.quote_count}
                  </span>
                </a>
                <a
                  title="Dar like"
                  ...
                  href={`https://twitter.com/intent/like?tweet_id=${repliedToData.id}`}
                  target="_blank"
                  rel="noopener noreferrer">
                  <svg
                    className="mr-2"
                  ...
                  <span>{repliedToData.public_metrics.like_count}</span>
                </a>
              </div>
            </div>
          </div>
