...
const QuotedTweet = ({ quotedTweetData, users }) => {
  ...
  useEffect(() => {
    users &&
      quotedTweetData &&
      quotedTweetData.author_id &&
      getUser(quotedTweetData.author_id);
        ...
        <a
          ...
          <div className="flex text-gray-700 mt-2">
            <a
              ...
              href={`https://twitter.com/intent/tweet?in_reply_to=${quotedTweetData.id}`}
              target="_blank"
              rel="noopener noreferrer">
              ...
              <span>{quotedTweetData.public_metrics.reply_count}</span>
            </a>
            <a
              title="Retweetear"
              ...
              href={`https://twitter.com/intent/retweet?tweet_id=${quotedTweetData.id}`}
              target="_blank"
              rel="noopener noreferrer">
              <svg className="mr-2" width="18" height="18" viewBox="0 0 24 24">
                <path
              ...
              <span>
                {quotedTweetData.public_metrics.retweet_count +
                  quotedTweetData.public_metrics.quote_count}
              </span>
            </a>
            <a
              title="Dar like"
              ...
              href={`https://twitter.com/intent/like?tweet_id=${quotedTweetData.id}`}
              target="_blank"
              rel="noopener noreferrer">
              <svg className="mr-2" width="18" height="18" viewBox="0 0 24 24">
                <path
              ...
              <span>{quotedTweetData.public_metrics.like_count}</span>
            </a>
          </div>
        </a>
      ) : (
