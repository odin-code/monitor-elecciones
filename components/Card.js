...
const Card = ({ role, name, img, details, linkRepo, github, linkedin }) => {
  return (
    <div class="w-full bg-white dark:bg-gray-850 dark:border-none rounded-md overflow-hidden border border-gray-300">
      <div class="md:flex">
        ...
        <div class="p-6">
          ...
          <a
            href={linkedin}
            class="block mt-1 text-lg leading-tight font-medium text-black dark:text-gray-200 hover:underline">
            {name}
          </a>
          ...
          <div className="flex items-center mt-4 space-x-2">
            <a href={github}>
              <svg
                class="fill-current text-gray-800 hover:text-gray-600 dark:text-gray-200 dark:hover:text-gray-400 h-6 w-6"
